...
/// <summary>
/// TechID: Tech_Buil_BallPit_Lv2_Opt2
/// ScopeType: SelfBuil
/// 策划描述: 射程+<val1>码，攻击速度+<val2>
/// UniqueValues: 150,40
/// </summary>
public class TechBuilBallPitLv2Opt2EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilBallPitLv2Opt2EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
