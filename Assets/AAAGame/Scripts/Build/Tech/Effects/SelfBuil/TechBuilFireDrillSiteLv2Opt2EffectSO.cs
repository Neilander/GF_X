...
/// <summary>
/// TechID: Tech_Buil_FireDrillSite_Lv2_Opt2
/// ScopeType: SelfBuil
/// 策划描述: 射程+<val1>码，攻击+<val2>
/// UniqueValues: 100,7
/// </summary>
public class TechBuilFireDrillSiteLv2Opt2EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilFireDrillSiteLv2Opt2EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
