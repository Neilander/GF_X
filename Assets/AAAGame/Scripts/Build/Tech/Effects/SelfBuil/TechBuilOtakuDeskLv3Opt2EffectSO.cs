...
/// <summary>
/// TechID: Tech_Buil_OtakuDesk_Lv3_Opt2
/// ScopeType: SelfBuil
/// 策划描述: 护甲+<val1>，生命上限+<val2>
/// UniqueValues: 2,30
/// </summary>
public class TechBuilOtakuDeskLv3Opt2EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilOtakuDeskLv3Opt2EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
