...
/// <summary>
/// TechID: Tech_Buil_InterviewRoom_Lv2_Opt2
/// ScopeType: SelfBuil
/// 策划描述: 攻击速度+<val1>
/// UniqueValues: 80
/// </summary>
public class TechBuilInterviewRoomLv2Opt2EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilInterviewRoomLv2Opt2EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
