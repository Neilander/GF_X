...
/// <summary>
/// TechID: Tech_Buil_PickupPoint_Lv2_Opt1
/// ScopeType: SelfBuil
/// 策划描述: 兵力+<val1>
/// UniqueValues: 3
/// </summary>
public class TechBuilPickupPointLv2Opt1EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilPickupPointLv2Opt1EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
    ...
    public override BuffData CreateBuildingScopedBuff(TechData techData, string techId)
    {
        ...
        Debug.LogWarning($"[{nameof(TechBuilPickupPointLv2Opt1EffectSO)}] 未实现字段: 兵力+<val1>（建筑属性） (techId={techId})");
