...
/// <summary>
/// TechID: Tech_Buil_Slaughterhouse_Lv2_Opt1
/// ScopeType: SelfBuil
/// 策划描述: 攻击+<val1>
/// UniqueValues: 20
/// </summary>
public class TechBuilSlaughterhouseLv2Opt1EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilSlaughterhouseLv2Opt1EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
