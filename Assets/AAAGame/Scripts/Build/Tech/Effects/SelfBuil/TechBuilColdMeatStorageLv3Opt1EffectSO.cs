...
/// <summary>
/// TechID: Tech_Buil_ColdMeatStorage_Lv3_Opt1
/// ScopeType: SelfBuil
/// 策划描述: 兵力+<val1>，攻击速度-<val2>
/// UniqueValues: 1,20
/// </summary>
public class TechBuilColdMeatStorageLv3Opt1EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilColdMeatStorageLv3Opt1EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
    ...
    public override BuffData CreateBuildingScopedBuff(TechData techData, string techId)
    {
        ...
        Debug.LogWarning($"[{nameof(TechBuilColdMeatStorageLv3Opt1EffectSO)}] 未实现字段: 兵力+<val1>（建筑属性） (techId={techId})");
