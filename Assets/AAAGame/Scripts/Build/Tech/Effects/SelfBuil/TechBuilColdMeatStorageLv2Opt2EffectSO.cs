...
/// <summary>
/// TechID: Tech_Buil_ColdMeatStorage_Lv2_Opt2
/// ScopeType: SelfBuil
/// 策划描述: 生命上限+<val1>,护甲+<val2>
/// UniqueValues: 150,2
/// </summary>
public class TechBuilColdMeatStorageLv2Opt2EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilColdMeatStorageLv2Opt2EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
