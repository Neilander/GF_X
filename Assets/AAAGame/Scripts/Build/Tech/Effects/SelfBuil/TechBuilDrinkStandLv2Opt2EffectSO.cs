...
/// <summary>
/// TechID: Tech_Buil_DrinkStand_Lv2_Opt2
/// ScopeType: SelfBuil
/// 策划描述: 射程+<val1>码，攻击+<val2>
/// UniqueValues: 200,4
/// </summary>
public class TechBuilDrinkStandLv2Opt2EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilDrinkStandLv2Opt2EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
