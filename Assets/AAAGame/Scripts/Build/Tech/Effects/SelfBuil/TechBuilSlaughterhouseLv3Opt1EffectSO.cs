...
/// <summary>
/// TechID: Tech_Buil_Slaughterhouse_Lv3_Opt1
/// ScopeType: SelfBuil
/// 策划描述: 攻击+<val1>,攻击速度+<val2>
/// UniqueValues: 20,25
/// </summary>
public class TechBuilSlaughterhouseLv3Opt1EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilSlaughterhouseLv3Opt1EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
