...
/// <summary>
/// TechID: Tech_Buil_PumpStation_Lv3_Opt1
/// ScopeType: SelfBuil
/// 策划描述: 攻击+<val1>,击退力度+<val2>
/// UniqueValues: 6,1
/// </summary>
public class TechBuilPumpStationLv3Opt1EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilPumpStationLv3Opt1EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
    ...
    public override BuffData CreateBuildingScopedBuff(TechData techData, string techId)
    {
        ...
        // TODO: 未实现字段 -> 击退力度+<val2>（特殊机制）
        Debug.LogWarning($"[{nameof(TechBuilPumpStationLv3Opt1EffectSO)}] 未实现字段: 击退力度+<val2>（特殊机制） (techId={techId})");
