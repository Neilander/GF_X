...
/// <summary>
/// TechID: Tech_Buil_PickupPoint_Lv2_Opt2
/// ScopeType: SelfBuil
/// 策划描述: 移动速度+<val1>，攻击+<val2>
/// UniqueValues: 50,2
/// </summary>
public class TechBuilPickupPointLv2Opt2EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilPickupPointLv2Opt2EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
