...
/// <summary>
/// TechID: Tech_Buil_DeliveryHub_Lv2_Opt2
/// ScopeType: SelfBuil
/// 策划描述: 移速加成转化为攻击的比例+<val2>
/// UniqueValues: 8
/// </summary>
public class TechBuilDeliveryHubLv2Opt2EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilDeliveryHubLv2Opt2EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
    ...
    public override BuffData CreateBuildingScopedBuff(TechData techData, string techId)
    {
        ...
        // TODO: 未实现字段 -> 移速加成转化为攻击的比例+<val2>（特殊机制）
        Debug.LogWarning($"[{nameof(TechBuilDeliveryHubLv2Opt2EffectSO)}] 未实现字段: 移速加成转化为攻击的比例+<val2>（特殊机制） (techId={techId})");
