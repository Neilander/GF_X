...
/// <summary>
/// TechID: Tech_Buil_PumpStation_Lv2_Opt2
/// ScopeType: SelfBuil
/// 策划描述: 攻击+<val1>，生命上限+<val2>
/// UniqueValues: 6,30
/// </summary>
public class TechBuilPumpStationLv2Opt2EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilPumpStationLv2Opt2EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
