...
/// <summary>
/// TechID: Tech_Buil_DeliveryHub_Lv2_Opt1
/// ScopeType: SelfBuil
/// 策划描述: 攻击+<val1>，生命上限+<val2>
/// UniqueValues: 10,25
/// </summary>
public class TechBuilDeliveryHubLv2Opt1EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilDeliveryHubLv2Opt1EffectSO)}] ResolvedScope 无 BuildingInstanceIds, techId={context.TechId}");
            return;
        }
