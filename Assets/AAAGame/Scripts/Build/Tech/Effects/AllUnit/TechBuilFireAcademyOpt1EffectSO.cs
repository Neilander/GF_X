...
/// <summary>
/// TechID: Tech_Buil_FireAcademy_Opt1
/// ScopeType: AllUnit
/// 策划描述: 我方单位首次受到的伤害降低<val1>%
/// UniqueValues: 50
/// </summary>
public class TechBuilFireAcademyOpt1EffectSO : TechEffectSO
{
    public override void Activate(TechEffectContext context)
    {
        ...
        {
            Debug.LogWarning($"[{nameof(TechBuilFireAcademyOpt1EffectSO)}] ResolvedScope 无 UnitTypes, techId={context.TechId}");
            return;
        }
    ...
    public override BuffData CreateUnitInitialBuff(TechData techData, UnitType unitType, string techId)
    {
        ...
        Debug.LogWarning($"[{nameof(TechBuilFireAcademyOpt1EffectSO)}] 未实现字段: 首次受到伤害降低<val1>%（特殊机制未实现） (techId={techId})");
