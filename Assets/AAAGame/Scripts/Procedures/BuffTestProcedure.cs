...
public class BuffTestProcedure : ProcedureBase
{
    ...
    private void SpawnTestUnits()
    {
        try
        {
            ...
            int playerEntityId = SoldierFactory.ShowSoldier(UnitType.Unit_Intern, new Vector3(0, 1, -8), SideType.PlayerSide, BrainType.Player);

            // 使用族生成创建友方码农单位（定时死亡Buff）
            bool friendSpawnSuccess = ClusterSpawnSystem.SpawnCluster(new Vector3(0, 1, -7), 5, 5f, 2f, UnitType.Unit_Intern, SideType.PlayerSide, BrainType.SoldierAI);
