...
public sealed class TechResearchInteractionOption : IInteractionOption
{
    ...
    public KeyValuePair<IngameValueType, int>[] CostResource => BuildManager.GetTechResourceCosts(_techId);

    public bool IsVisible()
    {
        return BuildManager.IsResearchOptionVisible(_owner, _techId);
    }

    public bool IsExecutable()
    {
        return BuildManager.IsResearchOptionExecutable(_owner, _techId);
    }
    ...
    public void Execute()
    {
        BuildManager.ResearchTech(_owner, _techId);
    }
