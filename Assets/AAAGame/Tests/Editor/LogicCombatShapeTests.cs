...
public class LogicCombatShapeTests
{
    ...
    private static List<string> GetBuildingPrefabPaths()
    {
        ...
        for (int i = 0; i < guids.Length; i++)
        {
            ...
            string relativePath = assetPath.Substring(Prefix.Length, assetPath.Length - Prefix.Length - ".prefab".Length);
            if (relativePath.StartsWith("Building/", System.StringComparison.Ordinal))
