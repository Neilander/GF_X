...
namespace UGF.EditorTools
{
    public static partial class DataTableUpdater
    {
        ...
        {
            if (tableFileWatcher != null || configFileWatcher != null || languageFileWatcher != null)
            {
                throw new InvalidOperationException("Game data file watchers are already running.");
            }
