    ...
    public sealed partial class DataTableProcessor
    {
        private static class DataProcessorRegistry
        {
            public static void RegisterAll(IDictionary<string, DataProcessor> dataProcessors, IList<KeyValuePair<int, string>> dropdownTypes)
            {
                ...
                Register(dataProcessors, dropdownTypes, new EnumArrayProcessor());
                Register(dataProcessors, dropdownTypes, new EnumNullableProcessor());
                Register(dataProcessors, dropdownTypes, new Fix64Processor());
                Register(dataProcessors, dropdownTypes, new Fix64ArrayProcessor());
                ...
                Register(dataProcessors, dropdownTypes, new StringFix64PairArrayProcessor());
                Register(dataProcessors, dropdownTypes, new StringIntPairArrayProcessor());
